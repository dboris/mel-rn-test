...
module FlatList = {
  ...
  let make = Obj.magic(createAnimatedComponent(Obj.magic(FlatList.make)))
}

module Image = {
  include Image

  let make = Obj.magic(createAnimatedComponent(Obj.magic(make)))
}
...
module SectionList = {
  ...
  let make = Obj.magic(createAnimatedComponent(Obj.magic(SectionList.make)))
}
